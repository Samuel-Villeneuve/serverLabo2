exports.initContacts = function () {
  ...
  contactsRepository.add(
    new Contact("Nicolas Chourot", "Nicolas.Chourot@clg.qc.ca", "450 430-3120")
  );
  contactsRepository.add(
    new Contact("Joel Dusablon", "Joel.Dusablon@clg.qc.ca", "450 430-3120")
  );
  contactsRepository.add(
    new Contact("Patrice Roy", "Patrice.Roy@clg.qc.ca", "450 430-3120")
  );
  contactsRepository.add({
    Id: 0,
